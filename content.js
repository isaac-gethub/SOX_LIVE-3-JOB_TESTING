// ============================================================================
// TIB Systems — SAP Testing Execution Guide | Version 3 (Wrenfield Holdings / Castellane Systems)
// Supabase-backed content, auth, and progress module
// Project: blfgwysgekfqhcafofhe  (tables: sapexec_v3_books, sapexec_v3_enrollments, sapexec_v3_progress)
// ============================================================================
...
export async function fetchCourseData() {
  ...
  for (const row of data) {
    ...
    byPart.get(row.part_numeral).books.push({
      ...
      // V3's table has no separate `transactions` column, unlike sapexec_books.
      transactions: (() => {
        const seen = new Set();
        const out = [];
